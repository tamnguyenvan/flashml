...
export FLASHML_FLUX_MODEL_DIR="${FLASHML_FLUX_MODEL_DIR:-${FLASHML_HOME}/weights/flux}"
export FLASHML_FLUX_LORA_PATH="${FLASHML_FLUX_LORA_PATH:-${FLASHML_HOME}/weights/flux/flux-object-remove-lora.safetensors}"
